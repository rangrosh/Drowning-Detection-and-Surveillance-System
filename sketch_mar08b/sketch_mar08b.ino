...
const char* password = "nibbason"; //password of your wifi
float latitude , longitude;
int year , month , date, hour , minute , second;
String date_str , time_str , lat_str , lng_str, data_str, distress;
int pm;
int count=0;
...
void loop()
{
 ...
 WiFiClient client = server.available(); // Check if a client has connected
  ...
  s += data_str;
  s += "</td></tr> <tr> <th>Condition</th> <td ALIGN=CENTER >";
  s += distress;
  s += "</td>  </tr> </table> ";
